...
demo1: dq 0x0123456789ABCDEF ;all data stored as a quad word (8 bytes). ends up stored as big endian
demo2: db 0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF ;data stored as bytes. ends up stored as little endian
